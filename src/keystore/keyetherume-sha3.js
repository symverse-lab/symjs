...
module.exports = {
    ...
    create: function (params, cb) {
        var keyBytes; var ivBytes; var self = this;
        params = params || {};
    ...
    recover: function (password, keyObject, cb) {
        var keyObjectCrypto; var iv; var salt; var ciphertext; var algo; var self = this;
    ...
    importFromFile: function (address, datadir, cb) {
        ...
        function findKeyfile (keystore, address, files) {
            var i; var len; var filepath = null;
